...
function initLazy(el: HTMLElement, binding: DirectiveBinding) {
  ...
  console.log(el.getBoundingClientRect(), el.offsetTop, document.body.clientHeight)
  console.log(elOffsetTop, contentHeight, document.documentElement.getBoundingClientRect())
